# -*- coding: utf-8 -*-
"""
Created on Tue Jan 10 09:07:05 2023
...
spectrums = [s for s in load_from_mgf('example/Tomato/ms_ms_tomato_identified.mgf')]

sirius_path = "example/Tomato/sirius"
