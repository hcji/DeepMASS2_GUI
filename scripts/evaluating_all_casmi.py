...
spectrums = [s for s in load_from_mgf('example/all_casmi.mgf')]

sirius_path = "example/sirius"
...
msfinder_path = "example/msfinder/Structure result-2081.txt"
